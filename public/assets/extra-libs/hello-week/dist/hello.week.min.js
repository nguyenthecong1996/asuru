        ...
        var i = s(1),
            ...
            n = (function () {
                function t(e) {
                    ...
                    this.options.selector !== t.cssClasses.CALENDAR &&
                        a.Utilities.addClass(
                            this.selector,
                            t.cssClasses.CALENDAR
                        ),
                        (this.calendar.navigation =
                            a.Utilities.creatHTMLElement(
                                this.selector,
                                t.cssClasses.NAVIGATION,
                                this.selector
                            )),
                        this.options.nav
                            ? ((this.calendar.prevMonth =
                              ...
                              this.calendar.nextMonth.addEventListener(
                                  "click",
                                  function () {
                                      s.next(function () {});
                                  }
                        ...
                        (this.calendar.week = a.Utilities.creatHTMLElement(
                            this.selector,
                            t.cssClasses.WEEK,
                            this.selector
                        )),
                        (this.calendar.month = a.Utilities.creatHTMLElement(
                            this.selector,
                            t.cssClasses.MONTH,
                            this.selector
                        )),
                        ...
                        a.Utilities.checkUrl(this.options.langFolder)
                            ? a.Utilities.readFile(
                                  this.options.langFolder,
                                  function (t) {
                                      (s.langs = JSON.parse(t)),
                                          s.init(function () {});
                                  }
                              )
                            : a.Utilities.readFile(
                ...
                return (
                    ...
                    (t.prototype.reset = function (e, s) {
                        void 0 === e && (e = {}),
                            this.clearCalendar(),
                            (this.options = a.Utilities.extend(
                                e,
                                t.initOptions
                            )),
                            this.init(s);
                    ...
                    (t.prototype.getDays = function () {
                        ...
                        return this.daysSelected.map(function (e) {
                            return a.Utilities.timestampToHuman(
                                e,
                                t.options.format,
                                t.langs
                            );
                    ...
                    (t.prototype.setMinDate = function (t) {
                        (this.options.minDate = new Date(t)),
                            this.options.minDate.setHours(0, 0, 0, 0),
                            this.options.minDate.setDate(
                                this.options.minDate.getDate() - 1
                            );
                    }),
                    (t.prototype.setMaxDate = function (t) {
                        (this.options.maxDate = new Date(t)),
                            this.options.maxDate.setHours(0, 0, 0, 0),
                            this.options.maxDate.setDate(
                                this.options.maxDate.getDate() + 1
                            );
                    }),
                    (t.prototype.init = function (t) {
                        if (
                            ...
                            (this.daysSelected = this.options.daysSelected
                                ...
                                : []),
                            this.daysSelected.length > 1 &&
                                !this.options.multiplePick)
                        )
                            throw new Error(
                                "There are " +
                                    this.daysSelected.length +
                                    " dates selected, but the multiplePick option\n                is " +
                                    this.options.multiplePick +
                                    "!"
                            );
                        (this.todayDate =
                            a.Utilities.setToTimestamp() -
                            1e3 * new Date().getTimezoneOffset() * 60),
                            (this.date = new Date()),
                    ...
                    (t.prototype.selectDay = function (e) {
                        this.daysOfMonth = this.selector.querySelectorAll(
                            "." + t.cssClasses.MONTH + " ." + t.cssClasses.DAY
                        );
                        for (
                            var s = 0, i = Object.keys(this.daysOfMonth);
                            s < i.length;
                            s++
                        ) {
                            var a = i[s];
                            this.handleClickInteraction(this.daysOfMonth[a], e),
                                this.options.range &&
                        ...
                        for (
                            var s = [],
                                ...
                                o = function (t) {
                                    ...
                                    return (
                                        e.setDate(e.getDate() + t), e.getTime()
                                    );
                                };
                            n <= e;
                            ...
                            s.push(
                                a.Utilities.timestampToHuman(
                                    n,
                                    i.FORMAT_DATE.DEFAULT,
                                    this.langs
                                )
                            ),
                                (n = o.call(n, 1));
                    ...
                    (t.prototype.handleClickInteraction = function (e, s) {
                        ...
                        e.addEventListener("click", function (e) {
                            var o = a.Utilities.getIndexForEventTarget(
                                n.daysOfMonth,
                                e.target
                            );
                            n.days[o].locked ||
                                ...
                                a.Utilities.toggleClass(
                                    e.target,
                                    t.cssStates.IS_SELECTED
                                ),
                                (n.days[o].isSelected = !n.days[o].isSelected),
                                n.options.range &&
                                    (n.intervalRange.begin &&
                                        n.intervalRange.end &&
                                        ((n.intervalRange.begin = void 0),
                                        (n.intervalRange.end = void 0),
                                        n.removeStatesClass()),
                                    n.intervalRange.begin &&
                                        !n.intervalRange.end &&
                                        ((n.intervalRange.end =
                                            n.days[o].timestamp),
                                        (n.daysSelected = n.getIntervalOfDates(
                                            n.intervalRange.begin,
                                            n.intervalRange.end
                                        )),
                                        a.Utilities.addClass(
                                            e.target,
                                            t.cssStates.IS_END_RANGE
                                        ),
                                        n.intervalRange.begin >
                                            n.intervalRange.end &&
                                            ((n.intervalRange.begin = void 0),
                    ...
                    (t.prototype.handleMouseInteraction = function (e) {
                        ...
                        e.addEventListener("mouseover", function (e) {
                            var i = a.Utilities.getIndexForEventTarget(
                                s.daysOfMonth,
                                e.target
                            );
                            if (
                                !(
                                    !s.intervalRange.begin ||
                                    (s.intervalRange.begin &&
                                        s.intervalRange.end)
                                )
                            ) {
                    ...
                    (t.prototype.creatWeek = function (e) {
                        ...
                        a.Utilities.addClass(s, t.cssClasses.DAY),
                            (s.textContent = e),
                            this.calendar.week.appendChild(s);
                    }),
                    ...
                    (t.prototype.createDay = function (e) {
                        var s = e.getDate(),
                            ...
                            o = {
                                day: s,
                                timestamp: a.Utilities.setToTimestamp(
                                    a.Utilities.formatDate(
                                        e.getDate(),
                                        e.getMonth(),
                                        e.getFullYear()
                                    )
                        ...
                        (this.days = this.days || {}),
                            ...
                            (i !== t.daysWeek.SUNDAY &&
                                i !== t.daysWeek.SATURDAY) ||
                                (a.Utilities.addClass(
                                    n,
                                    t.cssStates.IS_WEEKEND
                                ),
                                (o.isWeekend = !0)),
                            (this.options.locked ||
                                (this.options.disabledDaysOfWeek &&
                                    this.options.disabledDaysOfWeek.includes(
                                        i
                                    )) ||
                                (this.options.disablePastDays &&
                                    +this.date.setHours(0, 0, 0, 0) <=
                                        +this.defaultDate.setHours(0, 0, 0, 0) -
                                            1) ||
                                (this.options.minDate &&
                                    +this.options.minDate >= o.timestamp) ||
                                (this.options.maxDate &&
                                    +this.options.maxDate <= o.timestamp)) &&
                                (a.Utilities.addClass(
                                    n,
                                    t.cssStates.IS_DISABLED
                                ),
                                (o.locked = !0)),
                            this.options.disableDates &&
                                this.setDaysDisable(n, o),
                            this.todayDate === o.timestamp &&
                                this.options.todayHighlight &&
                                (a.Utilities.addClass(n, t.cssStates.IS_TODAY),
                                (o.isToday = !0)),
                            this.daysSelected.find(function (e) {
                                (e !== o.timestamp &&
                                    a.Utilities.setToTimestamp(e.toString()) !==
                                        o.timestamp) ||
                                    (a.Utilities.addClass(
                                        n,
                                        t.cssStates.IS_SELECTED
                            ...
                            o.timestamp === this.intervalRange.begin &&
                                a.Utilities.addClass(
                                    n,
                                    t.cssStates.IS_BEGIN_RANGE
                                ),
                            o.timestamp === this.intervalRange.end &&
                                a.Utilities.addClass(
                                    n,
                                    t.cssStates.IS_END_RANGE
                                ),
                            ...
                            this.calendar.month &&
                                this.calendar.month.appendChild(n),
                            (o.element = n),
                            (this.days[o.day] = o);
                    }),
                    (t.prototype.setDaysDisable = function (e, s) {
                        this.options.disableDates[0] instanceof Array
                            ? this.options.disableDates.map(function (i) {
                                  s.timestamp >=
                                      a.Utilities.setToTimestamp(i[0]) &&
                                      s.timestamp <=
                                          a.Utilities.setToTimestamp(i[1]) &&
                                      (a.Utilities.addClass(
                                          e,
                                          t.cssStates.IS_DISABLED
                                      ),
                        ...
                        var s = this,
                            i = function (i) {
                                n.daysHighlight[i].days[0] instanceof Array
                                    ? n.daysHighlight[i].days.map(function (
                                          n,
                                          o
                                      ) {
                                          e.timestamp >=
                                              ...
                                              s.setStyleDayHighlight(t, i, e);
                                      })
                                    : n.daysHighlight[i].days.map(function (n) {
                                          e.timestamp ===
                                              a.Utilities.setToTimestamp(n) &&
                                              s.setStyleDayHighlight(t, i, e);
                                      });
                            },
                            n = this;
                    ...
                    (t.prototype.setStyleDayHighlight = function (e, s, i) {
                        a.Utilities.addClass(e, t.cssStates.IS_HIGHLIGHT),
                            this.daysHighlight[s].title &&
                                ((i.tile = this.daysHighlight[s].title),
                                a.Utilities.setDataAttr(
                                    e,
                                    "data-title",
                                    this.daysHighlight[s].title
                                )),
                            this.daysHighlight[s].color &&
                                a.Utilities.setStyle(
                                    e,
                                    "color",
                                    this.daysHighlight[s].color
                                ),
                            this.daysHighlight[s].backgroundColor &&
                                a.Utilities.setStyle(
                                    e,
                                    "background-color",
                                    this.daysHighlight[s].backgroundColor
                    ...
                    (t.prototype.mounted = function () {
                        ...
                        for (
                            var e = this.options.weekStart;
                            e < this.langs.daysShort.length;
                            e++
                        )
                            t.push(e);
                    ...
                    (t.prototype.removeStatesClass = function () {
                        for (
                            var e = 0, s = Object.keys(this.daysOfMonth);
                            e < s.length;
                            e++
                        ) {
                            var i = s[e];
                            a.Utilities.removeClass(
                                this.daysOfMonth[i],
                                t.cssStates.IS_SELECTED
                            ),
                                a.Utilities.removeClass(
            ...
            return (
                (t.timestampToHuman = function (t, e, s) {
                    ...
                    return (e = (e = (e = (e = (e = (e = (e = (e = (e = (e =
                        e.replace("dd", i.getDate().toString())).replace(
                        "DD",
                        (i.getDate() > 9
                            ? i.getDate()
                            : "0" + i.getDate()
                        ).toString()
                    )).replace("mm", (i.getMonth() + 1).toString())).replace(
                        "MMM",
                        s.months[i.getMonth()]
                    )).replace(
                        "MM",
                    ...
                    )).replace("mmm", s.monthsShort[i.getMonth()])).replace(
                        "yyyy",
                        i.getFullYear().toString()
                    )).replace("YYYY", i.getFullYear().toString())).replace(
                        "YY",
                        i.getFullYear().toString().substring(2)
                    )).replace("yy", i.getFullYear().toString().substring(2)));
                }),
                ...
                (t.setToTimestamp = function (t) {
                    if (t && (!isNaN(Number(t)) || 3 !== t.split("-").length))
                        throw new Error("The date " + t + " is not valid!");
                    return t || "string" == typeof t
                        ? new Date(t + "T00:00:00Z").getTime()
                ...
                (t.extend = function (t, e) {
                    var s = e || {
                        selector: ".hello-week",
                        lang: "en",
                        langFolder: "/assets/extra-libs/hello-week/dist/langs/",
                        format: "DD/MM/YYYY",
                        monthShort: !1,
                        weekShort: !0,
                        defaultDate: null,
