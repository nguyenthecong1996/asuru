                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" placeholder="Price" name="price" value="{{ old('price') }}" min="0" step=any>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" placeholder="Weight" name="weight" value="{{ old('weight') }}" min="0" step=any>
                                <p class="help text-danger">{{ $errors->first('weight') }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-12 d-flex justify-content-center">
                            <div class="mt-3 mr-4"><a class="btn btn-secondary w-100 btn-cancel" href="{{ route('customers.warehouse.index', $customerId) }}">Cancel</a></div>
